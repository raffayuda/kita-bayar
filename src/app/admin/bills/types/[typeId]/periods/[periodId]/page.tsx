...
import { ArrowLeft, Search, Filter, User, MapPin, DollarSign, Calendar as CalendarIcon, CheckCircle, XCircle } from "lucide-react"
import Link from "next/link"

// Mock data jenis tagihan
const mockBillTypes = {
  1: { name: "Iuran Bulanan", icon: "💰" },
  2: { name: "17 Agustusan", icon: "🇮🇩" }
}

// Mock data periode
const mockPeriods = {
  1: { name: "September 2024", description: "Iuran bulanan September 2024" },
  2: { name: "Oktober 2024", description: "Iuran bulanan Oktober 2024" },
  5: { name: "17 Agustus 2024", description: "Peringatan kemerdekaan RI ke-79" }
}

// Mock data warga dengan sistem bulatan pembayaran dan data pembayaran per tanggal
const mockResidents = [
  {
    id: 1,
    name: "Budi Santoso",
    ...
    paymentHistory: [
      { date: "2024-09-05", amount: 10000, installment: 1 },
      { date: "2024-09-10", amount: 10000, installment: 2 },
      { date: "2024-09-15", amount: 10000, installment: 3 },
      { date: "2024-09-20", amount: 10000, installment: 4 },
      { date: "2024-09-25", amount: 10000, installment: 5 }
    ]
  },
  {
    id: 2,
    ...
    paymentHistory: [
      { date: "2024-09-08", amount: 10000, installment: 1 },
      { date: "2024-09-15", amount: 10000, installment: 2 }
    ]
  },
  {
    id: 3,
  ...
  },
  {
    ...
    paymentHistory: [
      { date: "2024-09-12", amount: 10000, installment: 1 },
      { date: "2024-09-18", amount: 10000, installment: 2 }
    ]
  }
]
...
export default function PeriodDetailPage() {
  ...
  const billType = mockBillTypes[typeId]
  ...
  const getPaymentsForDate = (date: Date) => {
    ...
    residents.forEach(resident => {
      resident.paymentHistory.forEach(payment => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-1">
          <div className="text-2xl">{billType.icon}</div>
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {billType.name} - {period.name}
            </h1>
          ...
          <Card>
            ...
            <CardContent>
              <Calendar
                ...
                components={{
                  Day: ({ date, ...props }) => {
                    const payments = getDayPayments(date)
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">
                Pembayaran {selectedDate.toLocaleDateString('id-ID')}
              </CardTitle>
            </CardHeader>
            <CardContent>
              {(() => {
                ...
                if (payments.length === 0) {
                  return (
                    <div className="text-center py-6 text-muted-foreground">
                      ...
                      <p>Tidak ada pembayaran pada tanggal ini</p>
                    </div>
                  )
                }
                    ...
                    {payments.map((payment, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">
                            {payment.houseNumber} • Cicilan ke-{payment.installment}
                          </div>
                        </div>
                        <div className="text-right">
